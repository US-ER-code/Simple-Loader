...
void load_and_run_elf(char** argv) {
  ...
  buff = calloc(1,ELF_si);				//dynamic memory allocation using calloc//
  ...
  ssize_t BYTES_red = read(fd, buff, ELF_si);	//reading ELF_si bytes from fd into a buffer 'buff'
